/* global ID, BLOG_ID, NAME, KEYWORD, QR_CODE, RANDOM, LOCK_TOC, LIB_URL, CSS_URL, EXCLUDES, REVERSE, TYPE */
    ...
    // 加载Readmore插件
      ...
      if (divArr && divArr.length > 0) {
        ...
        asyncLoadJs(LIB_URL, 'readmore-js', () => {
          // 初始化Readmore插件
          initPlugin(ID, BLOG_ID, NAME, KEYWORD, QR_CODE, RANDOM, LOCK_TOC, TYPE);
        })
      } else {
