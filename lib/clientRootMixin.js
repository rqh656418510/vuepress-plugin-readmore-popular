/* global ID, BLOG_ID, NAME, KEYWORD, QR_CODE, RANDOM, LOCK_TOC, LIB_URL, CSS_URL, EXCLUDES, REVERSE, INTERVAL, EXPIRES, HEIGHT, TYPE, BASEURL, ALLOW_MOBILE, WAIT_DOM_MILLS */
...
export default {
  ...
  mounted() {
    // 加载引流插件
    this.loadReadmorePlugin(WAIT_DOM_MILLS);
